...
namespace aruodas.ltOOPInheritance0731vak.Tests
{
    internal class garageTests
    {
        ...
        {
            string region = "Vilius";
            string settlement = "Vilniaus";
            string Microdistrict = "Lazdydai";
            string Street = "Raguvos";
            string Number = "777";

            Garage g = new Garage ("Vilnius", "Vilniaus", "Markučiai", "Tauro", "Garage", 2, "Multistorey car park", "5", "50", "5000000", "+37065432107", "nesakysiu@niekam.ut", "https://www.youtube.com/watch?v=31gM5gjw8A8",
        ...
        {
            Garage g = new Garage("Vilnius", "Vilniaus", "Markučiai", "Tauro", "Parking place", 2, "Multistorey car park", "5", "50", "5000000", "+37065432107", "nesakysiu@niekam.ut", "https://www.youtube.com/watch?v=31gM5gjw8A8",
                "https://www.youtube.com/watch?v=31gM5gjw8A8", "1234 - 5678 - 9011:4660", DescriptionGarage.LongDescription, new string[] { "Security", "Automatic gates", "Pit", "Basement", "Water", "Heating", "Exchange", "Auction" },
                new string[] { "Security", "Automatic gates", "Heating", "Lock", "Fenced", "Under the roof", "Storeroom", "Exchange", "Auction" }, 3, true, true, true);
